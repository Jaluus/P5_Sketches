var encoded_string =
  "    Zeit    und    Entfe   rnung                Wer Stoppt im Leben ist Tod, vergiss das Niemals! Alles wird Gut, für immer und für ewig     Jan        abcdefghijklmnopqrstuvwxyz.!?"; //
//"Zu lieben ist zu hassen, loszulassen und zu finde. Ich weiß das die Zukunft Hoffung birgt, das Jetzt ist erträglich. Jan";
...
encoded_string = encoded_string.substring(0, x_gridcells * y_gridcells);
...
var p1_follow_prob = 0.3;
var p2_follow_prob = 0.3;
...
function setup() {
  ...
  // COLOR SCHEME 1
  // bg_color = color("#F15412");
  // p1_color = color("#000000");
  // p2_color = color("#34B3F1");
  // p3_color = color("#EEEEEE");

  // COLOR SCHEME 2
  bg_color = color("#F4F4F4");
  p1_color = color("#FF7315");
  p2_color = color("#3A3535");
  p3_color = color("#232020");
